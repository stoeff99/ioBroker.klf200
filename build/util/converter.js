...
export const roleConverter = new EnumConverter(actuatorTypeMap);
export const roleGroupTypeConverter = new EnumConverter(groupTypeMap);
const levelTypeMap = {
...
export const levelConverter = new EnumConverter(levelTypeMap);
