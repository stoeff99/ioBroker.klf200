...
export class Setup {
    ...
    startStateTimer() {
        if (this._stateTimer === undefined) {
            this._stateTimer = setTimeout((adapter, gateway) => {
                (async () => {
    ...
    static async setupGlobalAsync(adapter, gateway) {
        ...
        await StateHelper.createAndSetStateAsync(adapter, "gateway.ProtocolVersion", {
        ...
        await StateHelper.createAndSetStateAsync(adapter, "gateway.SoftwareVersion", {
        ...
        await StateHelper.createAndSetStateAsync(adapter, "gateway.HardwareVersion", {
        ...
        await StateHelper.createAndSetStateAsync(adapter, "gateway.ProductGroup", {
            name: "ProductGroup",
            role: "value",
            type: "number",
            def: 0,
        ...
        await StateHelper.createAndSetStateAsync(adapter, "gateway.ProductType", {
            name: "ProductType",
            role: "value",
            type: "number",
            def: 0,
        ...
        const gatewayState = await gateway.getStateAsync();
        await StateHelper.createAndSetStateAsync(adapter, "gateway.GatewayState", {
            name: "GatewayState",
            role: "value",
            type: "number",
            min: 0,
        ...
        await StateHelper.createAndSetStateAsync(adapter, "gateway.GatewaySubState", {
        ...
        await StateHelper.createAndSetStateAsync(adapter, "gateway.RebootGateway", {
            name: "RebootGateway",
            role: "button.stop",
            type: "boolean",
            read: false,
