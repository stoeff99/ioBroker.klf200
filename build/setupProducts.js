"use strict";
import { ActuatorType, LimitationType, LockTime, ParameterActive, StatusType, } from "klf-200-api";
import { levelConverter, roleConverter } from "./util/converter.js";
import { ComplexPropertyChangedHandler, ComplexStateChangeHandler, EchoStateChangeHandler, PercentagePropertyChangedHandler, SimplePropertyChangedHandler, SimpleStateChangeHandler, } from "./util/propertyLink.js";
...
export class SetupProducts {
     ...
     */
    static async createProductsAsync(adapter, products, disposalMap, productLimitationError) {
        // Remove old products
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.productsFound`, {
     ...
     */
    static async createProductAsync(adapter, product, disposalMap, productLimitationError) {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.category`, {
            name: "category",
            role: roleConverter.convert(product.TypeID),
            type: "string",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.currentPosition`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.currentPositionRaw`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.FP1CurrentPositionRaw`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.FP2CurrentPositionRaw`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.FP3CurrentPositionRaw`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.FP4CurrentPositionRaw`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.nodeVariation`, {
            name: "nodeVariation",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.order`, {
            name: "order",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.placement`, {
            name: "placement",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.powerSaveMode`, {
            name: "powerSaveMode",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.productType`, {
            name: "productType",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.remainingTime`, {
            name: "remainingTime",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.runStatus`, {
            name: "runStatus",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.serialNumber`, {
            name: "serialNumber",
            role: "value",
            type: "string",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.state`, {
            name: "state",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.statusReply`, {
            name: "statusReply",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.subType`, {
            name: "subType",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.targetPosition`, {
            name: "targetPosition",
            role: levelConverter.convert(product.TypeID),
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.targetPositionRaw`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.timestamp`, {
            name: "timestamp",
            role: "value",
            type: "string",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.typeID`, {
            name: "typeID",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.velocity`, {
            name: "velocity",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.stop`, {
            name: "stop",
            role: "button.play",
            type: "boolean",
            read: false,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.wink`, {
            name: "wink",
            role: "button.play",
            type: "boolean",
            read: false,
        ...
        for (const parameterCounter of [1, 2, 3, 4]) {
            ...
            await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.${stateName}`, common, {}, 0xd400);
        }
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.refreshProduct`, {
            name: "refreshProduct",
            role: "button.play",
            type: "boolean",
            read: false,
        ...
        */
        for (const parameter of [
            ...
            if (!productLimitationError.has(JSON.stringify([product.NodeID, parameter]))) {
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}MinRaw`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}MaxRaw`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}Min`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}Max`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}Originator`, {
                ...
                adapter.log.warn(`The state products.${product.NodeID}.limitation${ParameterActive[parameter]}Originator will be removed in the next major release. Use products.${product.NodeID}.limitation${ParameterActive[parameter]}OriginatorMin and products.${product.NodeID}.limitation${ParameterActive[parameter]}OriginatorMax instead!` +
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}OriginatorMin`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}OriginatorMax`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRaw`, {
                ...
                adapter.log.warn(`The state products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRaw will be removed in the next major release. Use products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRawMin and products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRawMax instead!` +
                    ` If you don't use this state in your own scripts, aliases, visualizations or somewhere else you can safely ignore this message. Please don't open any issues regarding this informational message.`);
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRawMin`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRawMax`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}Time`, {
                ...
                adapter.log.warn(`The state products.${product.NodeID}.limitation${ParameterActive[parameter]}Time will be removed in the next major release. Use products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeMin and products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeMax instead!` +
                    ` If you don't use this state in your own scripts, aliases, visualizations or somewhere else you can safely ignore this message. Please don't open any issues regarding this informational message.`);
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeMin`, {
                ...
                await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeMax`, {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `products.${product.NodeID}.refreshLimitation`, {
        ...
        disposalMap.set(`products.${product.NodeID}.property.name`, new ComplexPropertyChangedHandler(adapter, "Name", product, async (newValue) => {
            await adapter.extendObject(`products.${product.NodeID}`, {
                common: {
                    name: newValue,
                },
        ...
        disposalMap.set(`products.${product.NodeID}.property.nodeVariation`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.nodeVariation`, "NodeVariation", product));
        disposalMap.set(`products.${product.NodeID}.property.order`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.order`, "Order", product));
        disposalMap.set(`products.${product.NodeID}.property.placement`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.placement`, "Placement", product));
        disposalMap.set(`products.${product.NodeID}.property.state`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.state`, "State", product));
        disposalMap.set(`products.${product.NodeID}.property.currentPositionRaw`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.currentPositionRaw`, "CurrentPositionRaw", product));
        disposalMap.set(`products.${product.NodeID}.property.currentPosition`, new PercentagePropertyChangedHandler(adapter, `products.${product.NodeID}.currentPosition`, "CurrentPosition", product));
        disposalMap.set(`products.${product.NodeID}.property.targetPositionRaw`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.targetPositionRaw`, "TargetPositionRaw", product));
        disposalMap.set(`products.${product.NodeID}.property.targetPosition`, new PercentagePropertyChangedHandler(adapter, `products.${product.NodeID}.targetPosition`, "TargetPosition", product));
        disposalMap.set(`products.${product.NodeID}.property.FP1CurrentPositionRaw`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.FP1CurrentPositionRaw`, "FP1CurrentPositionRaw", product));
        disposalMap.set(`products.${product.NodeID}.property.FP2CurrentPositionRaw`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.FP2CurrentPositionRaw`, "FP2CurrentPositionRaw", product));
        disposalMap.set(`products.${product.NodeID}.property.FP3CurrentPositionRaw`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.FP3CurrentPositionRaw`, "FP3CurrentPositionRaw", product));
        disposalMap.set(`products.${product.NodeID}.property.FP4CurrentPositionRaw`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.FP4CurrentPositionRaw`, "FP4CurrentPositionRaw", product));
        disposalMap.set(`products.${product.NodeID}.property.remainingTime`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.remainingTime`, "RemainingTime", product));
        disposalMap.set(`products.${product.NodeID}.property.timestamp`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.timestamp`, "TimeStamp", product));
        disposalMap.set(`products.${product.NodeID}.property.runStatus`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.runStatus`, "RunStatus", product));
        disposalMap.set(`products.${product.NodeID}.property.statusReply`, new SimplePropertyChangedHandler(adapter, `products.${product.NodeID}.statusReply`, "StatusReply", product));
        disposalMap.set(`products.${product.NodeID}.property.limitationMinRaw`, new ComplexPropertyChangedHandler(adapter, "LimitationMinRaw", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}MinRaw`, product.getLimitationMinRaw(parameter), true);
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}Min`, Math.round(product.getLimitationMin(parameter) * 100), true);
            }
        }));
        disposalMap.set(`products.${product.NodeID}.property.limitationMaxRaw`, new ComplexPropertyChangedHandler(adapter, "LimitationMaxRaw", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}MaxRaw`, product.getLimitationMaxRaw(parameter), true);
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}Max`, Math.round(product.getLimitationMax(parameter) * 100), true);
            }
        }));
        disposalMap.set(`products.${product.NodeID}.property.limitationOriginator`, new ComplexPropertyChangedHandler(adapter, "LimitationOriginator", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}Originator`, product.getLimitationOriginator(parameter), true);
            }
        }));
        disposalMap.set(`products.${product.NodeID}.property.limitationOriginatorMin`, new ComplexPropertyChangedHandler(adapter, "LimitationOriginatorMin", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}OriginatorMin`, product.getLimitationOriginatorMin(parameter), true);
            }
        }));
        disposalMap.set(`products.${product.NodeID}.property.limitationOriginatorMax`, new ComplexPropertyChangedHandler(adapter, "LimitationOriginatorMax", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}OriginatorMax`, product.getLimitationOriginatorMax(parameter), true);
            }
        }));
        disposalMap.set(`products.${product.NodeID}.property.limitationTimeRaw`, new ComplexPropertyChangedHandler(adapter, "LimitationTimeRaw", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRaw`, product.getLimitationTimeRaw(parameter), true);
                let limitationTime = NaN;
                try {
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}Time`, limitationTime, true);
            }
        }));
        disposalMap.set(`products.${product.NodeID}.property.limitationTimeRawMin`, new ComplexPropertyChangedHandler(adapter, "LimitationTimeRawMin", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRawMin`, product.getLimitationTimeRawMin(parameter), true);
                let limitationTimeMin = NaN;
                try {
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeMin`, limitationTimeMin, true);
            }
        }));
        disposalMap.set(`products.${product.NodeID}.property.limitationTimeRawMax`, new ComplexPropertyChangedHandler(adapter, "LimitationTimeRawMax", product, async (_newValue) => {
            for (const parameter of [
                ParameterActive.MP,
                ParameterActive.FP1,
                ParameterActive.FP2,
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeRawMax`, product.getLimitationTimeRawMax(parameter), true);
                let limitationTimeMax = NaN;
                try {
                ...
                await adapter.setStateChangedAsync(`products.${product.NodeID}.limitation${ParameterActive[parameter]}TimeMax`, limitationTimeMax, true);
            }
        }));
        ...
        const nodeVariationHandler = new SimpleStateChangeHandler(adapter, nodeVariationStateId, "NodeVariation", product);
        ...
        const orderHandler = new SimpleStateChangeHandler(adapter, orderStateId, "Order", product);
        ...
        const placementHandler = new SimpleStateChangeHandler(adapter, placementStateId, "Placement", product);
        ...
        const targetPositionHandler = new ComplexStateChangeHandler(adapter, targetPositionStateId, async (state) => {
            if (state !== undefined && state?.val !== undefined) {
                /*
                    ...
                    */
                let functionalParameters = undefined;
                for (const parameterCounter of [1, 2, 3, 4]) {
                    const stateFP = await adapter.getStateAsync(`products.${product.NodeID}.targetFP${parameterCounter}Raw`);
                ...
                await product.setTargetPositionAsync(state.val / 100, undefined, undefined, undefined, functionalParameters);
            }
        });
        ...
        const targetPositionRawHandler = new ComplexStateChangeHandler(adapter, targetPositionRawStateId, async (state) => {
            if (state !== undefined && state?.val !== undefined) {
                /*
                    Read the states of targetFP1Raw - targetFP4Raw.
                    For each state which is not set to Ignore (0xD400)
                ...
                */
                ...
                await product.setTargetPositionRawAsync(state.val, undefined, undefined, undefined, functionalParameters);
            }
        });
        ...
        const refreshProductListener = new ComplexStateChangeHandler(adapter, refreshProductStateId, async (state) => {
            if (state !== undefined) {
                if (state?.val === true) {
                    ...
                    const sessionId = await adapter.Products.requestStatusAsync(product.NodeID, StatusType.RequestCurrentPosition, [1, 2, 3, 4]);
                    try {
                        await waitForSessionFinishedNtfAsync(adapter, adapter.Connection, sessionId);
                    }
                    catch (e) {
                        if (e != "TimeoutError") {
                            throw e;
        ...
        const refreshLimitationListener = new ComplexStateChangeHandler(adapter, refreshLimitationStateId, async (state) => {
            if (state !== undefined) {
                if (state?.val === true) {
