"use strict";
import { GroupType } from "klf-200-api";
import { levelConverter, roleGroupTypeConverter } from "./util/converter.js";
import { ComplexPropertyChangedHandler, PercentageStateChangeHandler, SetterStateChangeHandler, SimplePropertyChangedHandler, SimpleStateChangeHandler, } from "./util/propertyLink.js";
...
export class SetupGroups {
     ...
     */
    static async createGroupsAsync(adapter, groups, products, disposalMap) {
        // Remove old groups
        ...
        await StateHelper.createAndSetStateAsync(adapter, `groups.groupsFound`, {
     ...
     * @param disposalMap - A map of disposables to clean up.
     */
    static async createGroupAsync(adapter, group, products, disposalMap) {
        ...
        await StateHelper.createAndSetStateAsync(adapter, `groups.${group.GroupID}.groupType`, {
            name: "groupType",
            role: roleGroupTypeConverter.convert(group.GroupType),
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `groups.${group.GroupID}.productsCount`, {
            name: "productsCount",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `groups.${group.GroupID}.nodeVariation`, {
            name: "nodeVariation",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `groups.${group.GroupID}.order`, {
            name: "order",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `groups.${group.GroupID}.placement`, {
            name: "placement",
            role: "value",
            type: "number",
            read: true,
        ...
        await StateHelper.createAndSetStateAsync(adapter, `groups.${group.GroupID}.velocity`, {
            name: "velocity",
            role: "value",
            type: "number",
            read: true,
        ...
        */
        ...
        disposalMap.set(`groups.${group.GroupID}.property.nodeVariation`, new SimplePropertyChangedHandler(adapter, `groups.${group.GroupID}.nodeVariation`, "NodeVariation", group));
        disposalMap.set(`groups.${group.GroupID}.property.order`, new SimplePropertyChangedHandler(adapter, `groups.${group.GroupID}.order`, "Order", group));
        disposalMap.set(`groups.${group.GroupID}.property.placement`, new SimplePropertyChangedHandler(adapter, `groups.${group.GroupID}.placement`, "Placement", group));
        disposalMap.set(`groups.${group.GroupID}.property.velocity`, new SimplePropertyChangedHandler(adapter, `groups.${group.GroupID}.velocity`, "Velocity", group));
        disposalMap.set(`groups.${group.GroupID}.property.groupType`, new SimplePropertyChangedHandler(adapter, `groups.${group.GroupID}.groupType`, "GroupType", group));
        disposalMap.set(`groups.${group.GroupID}.property.Nodes`, new ComplexPropertyChangedHandler(adapter, "Nodes", group, async (newValue) => {
        ...
        const nodeVariationHandler = new SimpleStateChangeHandler(adapter, nodeVariationStateId, "NodeVariation", group);
        ...
        const orderHandler = new SimpleStateChangeHandler(adapter, orderStateId, "Order", group);
        ...
        const placementHandler = new SimpleStateChangeHandler(adapter, placementStateId, "Placement", group);
        ...
        const targetPositionHandler = new PercentageStateChangeHandler(adapter, targetPositionStateId, group, "setTargetPositionAsync");
        ...
        const targetPositionRawHandler = new SetterStateChangeHandler(adapter, targetPositionRawStateId, group, "setTargetPositionRawAsync");
        ...
        const velocityHandler = new SimpleStateChangeHandler(adapter, velocityStateId, "Velocity", group);
